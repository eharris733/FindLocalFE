def generate_jsoncss_extraction_prompt(cleaned_html: str) -> str:
   ...
   schema = {
    ...
    target_json_fields = """
    "image": This will be a link to an image of the event. If there's an https:// missing, add it in.",
    "eventDate": "the full date, don't worry about cleaning it up, just extract it as is, e.g., "Friday, May 31, 2025" or "May 31",
    "startTime": will probably be the same as the event date. e.g "Sat Jun 1st 7:00 pm - 8:00 pm" or "8:00 pm". If not found, use "N/A",
    "endTime": will probably be the same as the event date. e.g "Sat Jun 1st 7:00 pm - 8:00 pm" or "8:00 pm". If not found, use "N/A",
    "title": e.g"Joni Mitchell's Alternate Tunings: A Four-Week Class with Ali Dineen",
    "description": This is the hardest one. It will be a brief description of the event or artists, can be multi-line text. If not found, use "N/A",
    """

...
## Requirements
* Hosts must have a creator/venue account to invite other people
* Depending on the host's settings, any invited people are required to have a passcode, be friends, or can respond anonymously with just the link. 
...
* Depnding on the settings of the event, invited people can see event details even without an account or passcode. 
...
* As a creator/venue, I can invite people to public events. 

## Visibility and Privacy
* Friends can see other friends that are attending any event and are displayed prominently in their dashboard. You can turn this setting off in your profile

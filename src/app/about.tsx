...
export default function AboutRoute() {
  ...
  return (
    ...
    >
      ...
      <Text variant="body1" style={{ marginBottom: theme.spacing.md, lineHeight: 22 }}>
        FindLocal utilizes modern web application technology, combined with AI-assisted gathering of data from public calendars to give you a one-stop shop for any event you can possibly think of. If it's not on here yet, but it is on the internet, you can email <Text style={{ textDecorationLine: 'underline', color: theme.colors.primary[500] }} onPress={() => openLink('mailto:findlocalinternal@gmail.com')}>findlocalinternal@gmail.com</Text> and it will be added promptly.
      </Text>
      <Text variant="h3" style={{ marginTop: theme.spacing.xl, marginBottom: theme.spacing.md }}>
        The team:
      </Text>
      ...
      <Text variant="body1" style={{ marginBottom: theme.spacing.md, lineHeight: 22 }}>
        A: Of course, more money would allow us to broaden the scope and speed at which we can operate. If you have any business inquiries (affiliate links, advertising, partnering, etc.), please email <Text style={{ textDecorationLine: 'underline', color: theme.colors.primary[500] }} onPress={() => openLink('mailto:findlocalinternal@gmail.com')}>findlocalinternal@gmail.com</Text>.
      </Text>
      <Text variant="h4" style={{ marginTop: theme.spacing.lg, marginBottom: theme.spacing.sm }}>
        Q: I want to help, how can I help?
      </Text>
      <Text variant="body1" style={{ marginBottom: theme.spacing.md, lineHeight: 22 }}>
        A: The best way is by filling out <Text style={{ textDecorationLine: 'underline', color: theme.colors.primary[500] }} onPress={() => openLink('https://forms.gle/diBZKyejuUXsdQu46')}>this form</Text> to become a beta tester. If you are interested in helping out in a more committal and serious way, please email <Text style={{ textDecorationLine: 'underline', color: theme.colors.primary[500] }} onPress={() => openLink('mailto:findlocalinternal@gmail.com')}>findlocalinternal@gmail.com</Text> and give a brief synopsis of your skills and interest.
      </Text>
      <Text variant="h4" style={{ marginTop: theme.spacing.lg, marginBottom: theme.spacing.sm }}>
      ...
      <Text variant="body1" style={{ marginBottom: theme.spacing.md, lineHeight: 22 }}>
        A: First of all, that's not a question. But please email <Text style={{ textDecorationLine: 'underline', color: theme.colors.primary[500] }} onPress={() => openLink('mailto:findlocalinternal@gmail.com')}>findlocalinternal@gmail.com</Text> with all the details needed for your inquiry or report and we thank you for your engagement!
      </Text>
      <Text variant="h4" style={{ marginTop: theme.spacing.lg, marginBottom: theme.spacing.sm }}>
        Q: How can I stay updated on all things FindLocal?
      </Text>
      <Text variant="body1" style={{ marginBottom: theme.spacing.xl, lineHeight: 22 }}>
        A: You can <Text style={{ textDecorationLine: 'underline', color: theme.colors.primary[500] }} onPress={() => openLink('https://www.instagram.com/findl0cal/')}>follow the gram</Text>! Also be sure to check the email preferences box to get updates on all new features and announcements.
      </Text>
    </ScrollView>
  );
}